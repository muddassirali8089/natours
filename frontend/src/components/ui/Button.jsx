...
const Button = ({
  ...
  const variantClasses = {
    ...
    outline: 'btn-outline border border-secondary-300 bg-transparent hover:bg-secondary-50 focus:ring-secondary-500',
    ghost: 'btn-ghost hover:bg-secondary-100 focus:ring-secondary-500',
